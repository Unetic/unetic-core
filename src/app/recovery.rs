...
fn matches_old_config(config: &crate::model::DesiredConfig, journal: &TransactionJournal) -> bool {
...
fn matches_new_config(config: &crate::model::DesiredConfig, journal: &TransactionJournal) -> bool {
