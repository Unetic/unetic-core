...
mod tests {
    ...
    use super::*;
    use crate::{MemoryBackend, StateStore, api};
    ...
    fn test_api_dispatch_ping_success() {
        ...
        let response_str = api::dispatch(&app, "tools.ping", r#"{"host":"127.0.0.1"}"#);
    ...
    fn test_api_dispatch_ping_invalid_argument() {
        ...
        let response_str = api::dispatch(&app, "tools.ping", r#"{"host":""}"#);
        let val: serde_json::Value = serde_json::from_str(&response_str).expect("valid json");
